...
angular.module('betting')
  .controller('ResultSummaryCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, Server_api_url, $http) {

    UserInfo_service.checkUrl();

    $('#heading').text("Agent Result Summary");
    UserInfo_service.setHeading("Agent Result Summary");
    ...
    data = $.param({ agent_id: UserInfo_service.getUser().user_id, status: 'Active' });
