...
angular.module('betting')
  .controller('AgentUserDataCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, $http, Server_api_url) {

    UserInfo_service.checkUrl();

    $('#heading').text("Agent User Data Dashboard");
    UserInfo_service.setHeading("Agent User Data Dashboard");
