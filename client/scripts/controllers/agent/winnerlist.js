...
angular.module('betting')
  .controller('WinnerListCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, Server_api_url, $http) {

    UserInfo_service.checkUrl();

    $('#heading').text("Agent Winner List Dashboard");
    UserInfo_service.setHeading("Agent Winner List Dashboard");

    $rootScope.filter_betstatus = 'Active';

    var data = $.param({ agent_id: UserInfo_service.getUser().user_id, win_result: "Win" });
