...
angular.module('betting')
  .controller('SalesCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, $http, Server_api_url) {

	UserInfo_service.checkUrl();

	$('#heading').text("Agent Sales Dashboard");
	UserInfo_service.setHeading("Agent Sales Dashboard");
