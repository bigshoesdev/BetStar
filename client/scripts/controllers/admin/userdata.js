...
angular.module('betting')
  .controller('AdminUserDataCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, $http, Server_api_url) {

    UserInfo_service.checkUrl();

    $('#heading').text("Admin User Data Dashboard");
    UserInfo_service.setHeading("Admin User Data Dashboard");
