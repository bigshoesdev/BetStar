...
angular.module('betting')
  .controller('StaffUserDataCtrl', function ($rootScope, $scope, $position, UserInfo_service, $interval, $http, Server_api_url) {

    UserInfo_service.checkUrl();

    $('#heading').text("Staff User Data Dashboard");
    UserInfo_service.setHeading("Staff User Data Dashboard");
